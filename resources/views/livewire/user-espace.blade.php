<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto h-screen">
    <div class="flex justify-center">
        <a href="/demande-form"
            class=" hover:underline text-center bg-green-600 text-white text-xl font-bold rounded-full my-6 py-3 px-10 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            Nouvelle Demande
        </a>
    </div>
    <hr>
    <h1 class="text-4xl font-bold text-slate-500">Mes Dossiers</h1>
