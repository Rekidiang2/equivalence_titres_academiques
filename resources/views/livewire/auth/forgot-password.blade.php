<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto min-h-screen bg-white">
    <div class="flex h-full items-center">
        <main class="w-full max-w-md mx-auto p-6 mt-14">
                ...
                <div class="p-4 sm:p-7 bg-blue-50">
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent='save'>
                            @if (session('success'))
                                <div
                                    class="p-1 m-1 text-center text-md text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400">
